...
namespace Volo.Abp.BlobStoring.OneDrive
{
    ...
    public class DefaultOneDriveBlobNamingNormalizerProvider_Tests : AbpBlobStoringOneDriveTestCommonBase
    {
        private readonly IBlobNamingNormalizer _blobNamingNormalizer;

        public DefaultOneDriveBlobNamingNormalizerProvider_Tests()
        {
